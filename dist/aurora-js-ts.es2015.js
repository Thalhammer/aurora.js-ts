...
var Demuxer = /** @class */ (function (_super) {
    ...
    function Demuxer(source, chunk) {
        ...
        _this.source = source;
        var received = false;
        _this.source.on("data", function (chunk) {
            received = true;
            list.append(chunk);
            try {
                _this.readChunk();
...
var WAVEDemuxer = /** @class */ (function (_super) {
    __extends$2(WAVEDemuxer, _super);
...
var AUDemuxer = /** @class */ (function (_super) {
    ...
    AUDemuxer.prototype.readChunk = function () {
        if (!this.readHeader && this.stream.available(24)) {
            ...
            var size = this.stream.readUInt32();
...
var AIFFDemuxer = /** @class */ (function (_super) {
    __extends$5(AIFFDemuxer, _super);
...
var LPCMDecoder = /** @class */ (function (_super) {
    __extends$6(LPCMDecoder, _super);
...
var XLAWDecoder = /** @class */ (function (_super) {
    __extends$8(XLAWDecoder, _super);
    ...
    XLAWDecoder.prototype.init = function () {
        ...
        if (this.format.formatID == 'ulaw') {
            for (var i = 0; i < this.table.length; i++) {
                ...
                var t = ((val & XLAWDecoder.QUANT_MASK) << 3) + XLAWDecoder.BIAS;
            ...
            for (var i = 0; i < this.table.length; i++) {
                var val = i ^ 0x55;
                var t = val & XLAWDecoder.QUANT_MASK;
                var seg = (val & XLAWDecoder.SEG_MASK) >>> XLAWDecoder.SEG_SHIFT;
                if (seg)
                    t = (t + t + 1 + 32) << (seg + 2);
                else
                    t = (t + t + 1) << 3;
    ...
    XLAWDecoder.SIGN_BIT = 0x80;
    XLAWDecoder.QUANT_MASK = 0xf;
    XLAWDecoder.SEG_SHIFT = 4;
    XLAWDecoder.SEG_MASK = 0x70;
...
var AudioDeviceBackend = /** @class */ (function (_super) {
    __extends$10(AudioDeviceBackend, _super);
...
var AudioDevice = /** @class */ (function (_super) {
    __extends$11(AudioDevice, _super);
...
var WebAudioDevice = /** @class */ (function (_super) {
    __extends$9(WebAudioDevice, _super);
    ...
    WebAudioDevice.Context = window.AudioContext || window.webkitAudioContext;
    WebAudioDevice.supported = WebAudioDevice.Context;
...
var BalanceFilter = /** @class */ (function (_super) {
    __extends$12(BalanceFilter, _super);
...
var VolumeFilter = /** @class */ (function (_super) {
    __extends$13(VolumeFilter, _super);
...
var BufferSource = /** @class */ (function (_super) {
    __extends$14(BufferSource, _super);
...
var FileSource = /** @class */ (function (_super) {
    __extends$15(FileSource, _super);
...
var HTTPSource = /** @class */ (function (_super) {
    __extends$16(HTTPSource, _super);
    ...
    HTTPSource.prototype.loop = function () {
        ...
        this.xhr.onabort = function () { _this.inflight = false; };
...
export { Base, Buffer, BufferList, UnderflowError, EventHost, Bitstream, Stream, WAVEDemuxer, AUDemuxer, AIFFDemuxer, LPCMDecoder, XLAWDecoder, WebAudioDevice, BalanceFilter, VolumeFilter, BufferSource, FileSource, HTTPSource, AudioDeviceBackend, AudioDevice, Decoder, Demuxer, Filter, Queue, SeekPoint, Asset, Player };
//# sourceMappingURL=aurora-js-ts.es2015.js.map
